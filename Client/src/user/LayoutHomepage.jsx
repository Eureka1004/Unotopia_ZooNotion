...
export default function AdminLayout() {
  ...
  const menuItems = [
    ...
    { key: "education", label: "EDUCATION", path: "/homepage/user/edukasi" },
    { key: "community", label: "COMMUNITY", path: "/homepage/user/community" },
    { key: "zoo", label: "ZOO", path: "/homepage/user/kebun-binatang" },
    { key: "artikel", label: "ARTIKEL", path: "/homepage/user/artikel" },
    { key: "profil", label: "PROFIL", path: "/homepage/user/profil" },
  ];
