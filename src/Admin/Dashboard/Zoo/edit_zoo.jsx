...
export default function Tambah_zoo({ onClose }) {
  const [namaKebunbinatang, setNamaKebun] = useState("");
  const [deskripsi, setDeskripsi] = useState("");
  const [linkwebsite, setWebsite] = useState([]);
  const [linktiket, setTiket] = useState([]);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Kirim ke backend
    console.log("Nama:", namaKebunbinatang);
    console.log("Deskripsi:", deskripsi);
    console.log("LinkWebsite:", linkwebsite);
    console.log("LinkTiket:", linktiket);
  ...
  return (
    <div className="py-4 px-2">
      <form onSubmit={handleSubmit} className="bg-white shadow border p-6 rounded-lg max-w-lg mx-auto">
        ...
        {/* Nama Event */}
        <div className="mb-4">
          <label className="block mb-1 text-sm font-semibold text-gray-700">Nama Kebun binatang</label>
          <input
            type="text"
        ...
        {/* Deskripsi */}
        <div className="mb-4">
          <label className="block mb-1 text-sm font-semibold text-gray-700">Deskripsi Kebun binatang</label>
          <textarea
